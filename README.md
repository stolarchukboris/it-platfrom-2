...
1. Зарегистрироваться, если у вас еще нет учетной записи (/auth/register). Используйте свой email-адрес и пароль, состоящий из как минимум 10 символов.
2. Войти в систему с данными, с которыми вы регистрировались (/auth/login). Если все верно, вам будет выдан токен авторизации, который необходимо сохранить.
